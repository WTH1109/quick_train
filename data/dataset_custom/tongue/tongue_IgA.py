...
class TongueDataset(Dataset):
    def __init__(self, data_dir, data_type='img', split='train', data_phase='tongue', image_format='jpg',resize_size=512, sample_num=6):
        """
        Args:
        ...
        self.label_map = {'no_IgA': 0, 'IgA': 1}

        self.json_file = os.path.join(self.data_dir, 'train_test_data_info.json')
        ...
        if data_phase == 'tongue':
            self.img_path_idx_name = 'tongue_path'
        elif data_phase == 'face':
            self.img_path_idx_name = 'face_path'
        elif data_phase == 'tongue_cutting':
            self.img_path_idx_name = 'cutting_tongue_path'
        elif data_phase == 'tongue_region':
            self.img_path_idx_name = 'tongue_path'
    ...
    def __getitem__(self, idx):
        ...
        patient_phase = data_info['patient_phase']
