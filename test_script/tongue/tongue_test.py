...
if __name__ == '__main__':
    ...
    opt = main_opt_get(['-c', '/media/ps/data/home/wengtaohan/Code/quick_train/configs/base_config/tongue/ResNet_tongue_sam.yaml'])
    ...
    model_dict = torch.load('/media/ps/data/home/wengtaohan/Code/quick_train/logs/ResNet_tongue/D2025-03-13T20-14-10_ResNet_tongue_lr1e5/checkpoints/epoch=16-val_loss=0.50.ckpt'
