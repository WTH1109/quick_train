...
Diagnostics = TongueReference(yaml_path='configs/base_config/tongue/ResNet_tongue_tabular.yaml',
                            ckpt_path='logs/ResNet_tongue_tabular/D2025-03-17T21-20-02_ResNet_tongue_tabular_weight/checkpoints/epoch=23-val_loss=0.45.ckpt')
...
for key, data_info in data_all_dic.items():
    ...
    image_name = 'val_tongue_cut%sT.png' % str(key)
