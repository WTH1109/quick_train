...
Diagnostics = TongueReference(yaml_path='configs/base_config/tongue/ResNet_tongue_multi.yaml',
                            ckpt_path='logs/ResNet_tongue_multi/D2025-03-13T19-10-07_ResNet_tongue_multi/checkpoints/epoch=53-val_loss=0.42.ckpt')
